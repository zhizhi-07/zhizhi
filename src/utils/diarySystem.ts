...
6. **⚠️ 重要：只能写已经发生的事！现在才${new Date().getHours()}点，不要写下午、晚上等未来的事情！**
...
**⚠️ 时间限制：**
现在是${new Date().getHours()}点，只能写到现在为止发生的事！
- 如果是上午（0-12点），不要写下午、晚上的事
- 如果是下午（12-18点），不要写晚上的事
- 只写已经发生的，不要预测未来
