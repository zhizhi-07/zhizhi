...
## ⚠️ 重要：你必须STEP BY STEP逐步思考

你将按照【思考链】的步骤，一步一步分析，最后输出剧本JSON。
...
{
  "thinking": {
    "step1_人设解读": "每个角色的性格、说话方式、当前情绪、态度...",
    "step2_关系分析": "角色之间的关系网络、矛盾点...",
    "step3_事件分析": "用户意图、话题类型、预期参与者...",
    "step4_剧情构思": "开场-冲突-转折-高潮-结局...",
    "step5_台词要点": "如何让每个角色说话符合人设..."
  },
  "relationships": "简短总结角色关系",
  "plot": "简短总结剧情",
  "actions": [
    {"actorName": "角色名", "content": "对话内容"}
  ]
}
...
`
    ...
    console.log('')
    console.log('🧠 ═══════════════════════════════════════════════════')
    console.log('🧠 AI导演的完整思考过程')
    console.log('🧠 ═══════════════════════════════════════════════════')
    console.log('')
    
    // 展示思考过程
    if (scriptData.thinking) {
      console.log('📍 【步骤1：人设解读】')
      console.log('─────────────────────────────────────────')
      console.log(scriptData.thinking.step1_人设解读 || '（未提供）')
      console.log('')
      
      console.log('📍 【步骤2：关系分析】')
      console.log('─────────────────────────────────────────')
      console.log(scriptData.thinking.step2_关系分析 || '（未提供）')
      console.log('')
      
      console.log('📍 【步骤3：事件分析】')
      console.log('─────────────────────────────────────────')
      console.log(scriptData.thinking.step3_事件分析 || '（未提供）')
      console.log('')
      
      console.log('📍 【步骤4：剧情构思】')
      console.log('─────────────────────────────────────────')
      console.log(scriptData.thinking.step4_剧情构思 || '（未提供）')
      console.log('')
      
      console.log('📍 【步骤5：台词要点】')
      console.log('─────────────────────────────────────────')
      console.log(scriptData.thinking.step5_台词要点 || '（未提供）')
      console.log('')
      
      console.log('🧠 ═══════════════════════════════════════════════════')
      console.log('')
    } else {
      console.log('⚠️ AI未提供思考过程')
      console.log('')
    }
