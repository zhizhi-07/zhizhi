  ...
  const updateLogs = [
    {
      version: 'v1.0.0',
      date: '2025-10-20',
      summary: 'v1.0.0 正式版发布',
      changes: [
        '💰 零钱系统：支持充值、红包、转账、亲密付等完整功能',
        '💬 消息功能：支持引用回复、撤回消息、查看撤回内容',
        '🔥 续火花功能：记录连续聊天天数，解锁成就里程碑',
        '📝 AI日记功能：AI可以根据聊天记录写日记',
        '🧠 记忆系统优化：更自然的记忆总结，新增手动总结按钮',
        '🤖 AI行为优化：提示词精简66%，更真实的情感表达',
        '🎨 UI优化：新增状态栏、帮助中心等界面优化',
        '🐛 Bug修复：修复Settings页面编译错误等问题'
      ]
    }
  ]
