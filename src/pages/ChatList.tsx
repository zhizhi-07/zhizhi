              ...
              <>
                ...
                <div className="absolute right-0 top-full mt-2 w-44 glass-card rounded-2xl shadow-xl z-40 overflow-hidden">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3.5 text-left text-gray-400 ios-button flex items-center gap-3 cursor-not-allowed"
                    disabled
                  >
                    <div className="w-8 h-8 rounded-lg bg-white border border-gray-200 flex items-center justify-center">
                    ...
                    <div className="flex-1">
                      ...
                      <span className="text-xs block mt-0.5">敬请期待</span>
                    </div>
                  </button>
                </div>
              </>
